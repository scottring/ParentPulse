    ...
    questions: [
      {
        ...
        emoji: '😡',
        options: [
          { value: 'not_listening', label: "When we don't listen", emoji: '🙉' },
          { value: 'mess', label: 'When the house is messy', emoji: '🧹' },
          { value: 'running_late', label: "When we're running late", emoji: '⏰' },
          { value: 'work', label: 'Work stuff', emoji: '💼' },
          { value: 'loud_noises', label: 'When it gets too loud', emoji: '🔊' },
          { value: 'fighting', label: 'When we fight or argue', emoji: '😤' },
          { value: 'wrong', label: 'When things go wrong', emoji: '❌' },
          { value: 'homework', label: 'Homework time', emoji: '📝' },
          { value: 'screen_time', label: 'Screen time arguments', emoji: '📱' },
          { value: 'tired', label: 'When they are really tired', emoji: '😩' },
        ],
        required: false,
      },
      {
        ...
        options: [
          ...
          { value: 'gets_loud', label: 'Raises their voice', emoji: '📢' },
          { value: 'walks_away', label: 'Goes to another room', emoji: '🚶' },
          { value: 'talks_about', label: 'Talks about what happened', emoji: '💬' },
          { value: 'sighs', label: 'Sighs a lot', emoji: '😮‍💨' },
          { value: 'gets_busy', label: 'Starts cleaning or doing stuff', emoji: '🏃' },
          { value: 'snaps', label: 'Gets grumpy with everyone', emoji: '😠' },
          { value: 'phone', label: 'Goes on their phone', emoji: '📱' },
        ],
        required: false,
      },
      {
